...
public class CompletePaymentFormWithSpecificCreditCardOnSwabiz implements Task {

    private AirBookingFlow airBookingFlow;

    public CompletePaymentFormWithSpecificCreditCardOnSwabiz(AirBookingFlow airBookingFlow) {
